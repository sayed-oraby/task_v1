                        ...
                        <div class="m-stack__item m-brand m-brand--skin-dark">
                            <div class="m-stack m-stack--ver m-stack--general">
                                <div class="m-stack__item m-stack__item--middle m-brand__logo">
                                    <a href="{{ url('/provider') }}" class="m-brand__logo-wrapper" style="font-size: 25px;color: #FFF;">
                                        Dashboard
                                    </a>
                                </div>
                                                    ...
                                                    <div class="m-dropdown__header m--align-center" style="background: url({{asset('Front_End')}}/admin/img/user_profile_bg.jpg); background-size: cover;">
                                                        <div class="m-card-user m-card-user--skin-dark">
                                                            ...
                                                            <div class="m-card-user__details">
                                                                <span class="m-card-user__name m--font-weight-500"> {{ Auth::guard('provider')->user()->name }} </span>
                                                        ...
                                                        <div class="m-dropdown__content">
                                                            <ul class="m-nav m-nav--skin-light">
                                                                <li class="m-nav__item">
                                                                    <a href="{{ url('provider/logout') }}" class="btn m-btn--pill btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
