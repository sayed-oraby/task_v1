...
<div class="m-portlet m-portlet--tab">
    ...
    @php
        ...
        $count = App\Models\Locations::where('provider_id',$provider_id)->get(['id'])->count();   
    @endphp
        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="{{ url('provider/locations/create') }}" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
                ...
                <tbody>
                    ...
                    @php $x = 1; @endphp 
                            ...
                            <tr>
                                ...
                                <td nowrap>
                                    <a href="{{ url('provider/locations/'). '/' . $value->id . '/edit'}}" class='m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill' title='Edit'>
        ...
        $(document).ready(function () {
            ...
            $('#m_table_1').on('click', '.DeletingModal', function () {
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.href = '{{ url('provider/locations/destroy') }}' + '/' + ID;
